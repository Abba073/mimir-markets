...
export function parseAdvertisedPrice(price: string | undefined): bigint | null {
  ...
  // SEVEN decimals, not six. This regex was written for the 6-decimal ERC-20 and
  // is the price gate's own copy of the precision rule — so while `parseUsdcAtomic`
  // accepts a 7th decimal place, this rejected it as unparseable and an honestly
  // advertised sub-cent price was refused outright. An EIGHTH place is still
  // unrepresentable and still refused.
